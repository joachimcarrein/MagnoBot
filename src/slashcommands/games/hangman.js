...
module.exports = {
    ...
    run: async ({client, interaction}) => {
        ...
        const hangman = client.commands.get("hangman")
        ...
        interaction.reply("Hangman will start in a few moments.")

        new hangman.HangManGame().newGame(json.word.toLowerCase(), interaction, client, false, hangman.letterEmojisMap)
    }
}